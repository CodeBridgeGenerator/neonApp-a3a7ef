const { ChataiConfig } = require("./chataiConfig.class");
const createModel = require("./chataiConfig.model");
const hooks = require("./chataiConfig.hooks");
...
module.exports = function (app) {
  ...
  app.use("/chataiConfig", new ChataiConfig(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("chataiConfig");

  // Get the schema of the collections
  app.get("/chataiConfigSchema", function (request, response) {
