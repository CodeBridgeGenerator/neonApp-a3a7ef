const { ChataiEnabler } = require("./chataiEnabler.class");
const createModel = require("./chataiEnabler.model");
const hooks = require("./chataiEnabler.hooks");
...
module.exports = function (app) {
  ...
  app.use("/chataiEnabler", new ChataiEnabler(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("chataiEnabler");

  // Get the schema of the collections
  app.get("/chataiEnablerSchema", function (request, response) {
