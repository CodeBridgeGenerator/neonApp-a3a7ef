const { ChataiPrompts } = require("./chataiPrompts.class");
const createModel = require("./chataiPrompts.model");
const hooks = require("./chataiPrompts.hooks");
...
module.exports = function (app) {
  ...
  app.use("/chataiPrompts", new ChataiPrompts(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("chataiPrompts");

  // Get the schema of the collections
  app.get("/chataiPromptsSchema", function (request, response) {
