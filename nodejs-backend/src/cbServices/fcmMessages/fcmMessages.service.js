const { FcmMessages } = require("./fcmMessages.class");
const createModel = require("./fcmMessages.model");
const hooks = require("./fcmMessages.hooks");
...
module.exports = function (app) {
  ...
  app.use("/fcmMessages", new FcmMessages(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("fcmMessages");

  // Get the schema of the collections
  app.get("/fcmMessagesSchema", function (request, response) {
