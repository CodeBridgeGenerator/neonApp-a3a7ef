const { Fcms } = require("./fcms.class");
const createModel = require("./fcms.model");
const hooks = require("./fcms.hooks");
...
module.exports = function (app) {
  ...
  app.use("/fcms", new Fcms(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("fcms");

  // Get the schema of the collections
  app.get("/fcmsSchema", function (request, response) {
