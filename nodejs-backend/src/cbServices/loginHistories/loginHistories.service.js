const { LoginHistories } = require("./loginHistories.class");
const createModel = require("./loginHistories.model");
const hooks = require("./loginHistories.hooks");
...
module.exports = function (app) {
  ...
  app.use("/loginHistories", new LoginHistories(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("loginHistories");

  // Get the schema of the collections
  app.get("/loginHistoriesSchema", function (request, response) {
