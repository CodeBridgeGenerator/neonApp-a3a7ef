const { UserGuideSteps } = require("./userGuideSteps.class");
const createModel = require("./userGuideSteps.model");
const hooks = require("./userGuideSteps.hooks");
...
module.exports = function (app) {
  ...
  app.use("/userGuideSteps", new UserGuideSteps(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("userGuideSteps");

  // Get the schema of the collections
  app.get("/userGuideStepsSchema", function (request, response) {
