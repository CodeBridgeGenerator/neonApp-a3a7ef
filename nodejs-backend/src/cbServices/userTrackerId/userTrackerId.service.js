const { UserTrackerId } = require("./userTrackerId.class");
const createModel = require("./userTrackerId.model");
const hooks = require("./userTrackerId.hooks");
...
module.exports = function (app) {
  ...
  app.use("/userTrackerId", new UserTrackerId(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("userTrackerId");

  // Get the schema of the collections
  app.get("/userTrackerIdSchema", function (request, response) {
