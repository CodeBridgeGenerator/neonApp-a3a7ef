const { CustomerAddress } = require("./customerAddress.class");
const createModel = require("./customerAddress.model");
const hooks = require("./customerAddress.hooks");
...
module.exports = function (app) {
  ...
  app.use("/customerAddress", new CustomerAddress(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("customerAddress");

  // Get the schema of the collections
  app.get("/customerAddressSchema", function (request, response) {
