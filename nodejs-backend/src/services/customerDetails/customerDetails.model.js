...
customerEmail: { type:  String , comment: "Customer Email, p, false, true, true, true, true, true, true, , , , ," },
customerAddress: { type:  String , comment: "Customer Address, p, false, true, true, true, true, true, true, , , , ," },
phoneNumber: { type:  String , comment: "Phone Number, p, false, true, true, true, true, true, true, , , , ," },
