const { CustomerEmail } = require("./customerEmail.class");
const createModel = require("./customerEmail.model");
const hooks = require("./customerEmail.hooks");
...
module.exports = function (app) {
  ...
  app.use("/customerEmail", new CustomerEmail(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("customerEmail");

  // Get the schema of the collections
  app.get("/customerEmailSchema", function (request, response) {
