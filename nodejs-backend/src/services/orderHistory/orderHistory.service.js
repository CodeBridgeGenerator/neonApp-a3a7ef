const { OrderHistory } = require("./orderHistory.class");
const createModel = require("./orderHistory.model");
const hooks = require("./orderHistory.hooks");
...
module.exports = function (app) {
  ...
  app.use("/orderHistory", new OrderHistory(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("orderHistory");

  // Get the schema of the collections
  app.get("/orderHistorySchema", function (request, response) {
