const { OrderProduct } = require("./orderProduct.class");
const createModel = require("./orderProduct.model");
const hooks = require("./orderProduct.hooks");
...
module.exports = function (app) {
  ...
  app.use("/orderProduct", new OrderProduct(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("orderProduct");

  // Get the schema of the collections
  app.get("/orderProductSchema", function (request, response) {
