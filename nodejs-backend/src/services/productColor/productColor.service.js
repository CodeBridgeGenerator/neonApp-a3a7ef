const { ProductColor } = require("./productColor.class");
const createModel = require("./productColor.model");
const hooks = require("./productColor.hooks");
...
module.exports = function (app) {
  ...
  app.use("/productColor", new ProductColor(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("productColor");

  // Get the schema of the collections
  app.get("/productColorSchema", function (request, response) {
