const { ProductPrice } = require("./productPrice.class");
const createModel = require("./productPrice.model");
const hooks = require("./productPrice.hooks");
...
module.exports = function (app) {
  ...
  app.use("/productPrice", new ProductPrice(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("productPrice");

  // Get the schema of the collections
  app.get("/productPriceSchema", function (request, response) {
