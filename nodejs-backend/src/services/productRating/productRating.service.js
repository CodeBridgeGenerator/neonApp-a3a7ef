const { ProductRating } = require("./productRating.class");
const createModel = require("./productRating.model");
const hooks = require("./productRating.hooks");
...
module.exports = function (app) {
  ...
  app.use("/productRating", new ProductRating(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("productRating");

  // Get the schema of the collections
  app.get("/productRatingSchema", function (request, response) {
