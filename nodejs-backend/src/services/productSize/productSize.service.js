const { ProductSize } = require("./productSize.class");
const createModel = require("./productSize.model");
const hooks = require("./productSize.hooks");
...
module.exports = function (app) {
  ...
  app.use("/productSize", new ProductSize(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("productSize");

  // Get the schema of the collections
  app.get("/productSizeSchema", function (request, response) {
