const { ProductStock } = require("./productStock.class");
const createModel = require("./productStock.model");
const hooks = require("./productStock.hooks");
...
module.exports = function (app) {
  ...
  app.use("/productStock", new ProductStock(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("productStock");

  // Get the schema of the collections 
  app.get("/productStockSchema", function (request, response) {
