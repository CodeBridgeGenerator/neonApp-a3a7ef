...
describe("category service", async () => {
  ...
  describe("#create", () => {
    const options = {"brandName":"new value","gender":"new value","isSale":true,"productPrice":23,"productImage":"new value","productSearch":"new value","sortBy":"new value"};
...
assert.strictEqual(categoryCreated.sortBy, options.sortBy);
  ...
  describe("#update", () => {
    const options = {"brandName":"updated value","gender":"updated value","isSale":false,"productPrice":100,"productImage":"updated value","productSearch":"updated value","sortBy":"updated value"};
