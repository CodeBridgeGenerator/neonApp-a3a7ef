...
describe("customerDetails service", async () => {
  ...
  describe("#create", () => {
    const options = {"customerName":"new value","customerEmail":"new value","customerAddress":"new value","phoneNumber":"new value","gender":"new value","dateOfBirth":"2026-04-17T02:57:11.937Z"};
...
assert.strictEqual(customerDetailCreated.customerAddress, options.customerAddress);
...
assert.strictEqual(customerDetailCreated.dateOfBirth.toISOString(), options.dateOfBirth);
  ...
  describe("#update", () => {
    const options = {"customerName":"updated value","customerEmail":"updated value","customerAddress":"updated value","phoneNumber":"updated value","gender":"updated value","dateOfBirth":"2026-04-17T02:57:11.937Z"};
...
assert.strictEqual(customerDetailUpdated.customerAddress, options.customerAddress);
