...
describe("product service", async () => {
  ...
  const productPriceCreated = await app.service("productPrice").Model.create({"productTitle":"new value","description":"new value","price":"parentObjectId","productName":"new value","basePrice":23,"currency":23,"discountedPrice":"new value","taxPercentage":"new value"});
  ...
  describe("#create", () => {
    const options = {"productTitle":"new value","description":"new value","price":`${productPriceCreated._id}`,"productName":"new value","basePrice":23,"currency":23,"discountedPrice":"new value","taxPercentage":"new value","productImage":"new value","smallImage":"new value"};
...
assert.strictEqual(productCreated.smallImage, options.smallImage);
  ...
  describe("#update", () => {
    const options = {"productTitle":"updated value","description":"updated value","price":`${productPriceCreated._id}`,"productImage":"updated value","smallImage":"updated value"};
