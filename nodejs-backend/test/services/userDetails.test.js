...
describe("userDetails service", async () => {
  ...
  const customerEmailCreated = await app.service("customerEmail").Model.create({"fullName":"new value","phoneNumber":"new value","email":"new value"});
  ...
  describe("#create", () => {
    const options = {"fullName":"new value","phoneNumber":"new value","email":`${customerEmailCreated._id}`,"passwordHash":"new value"};
...
assert.strictEqual(userDetailCreated.email.toString(), options.email.toString());
assert.strictEqual(userDetailCreated.passwordHash, options.passwordHash);
  ...
  describe("#update", () => {
    const options = {"fullName":"updated value","phoneNumber":"updated value","email":`${customerEmailCreated._id}`,"passwordHash":"updated value"};
...
assert.strictEqual(userDetailUpdated.email.toString(), options.email.toString());
assert.strictEqual(userDetailUpdated.passwordHash, options.passwordHash);
  ...
  describe("#delete", async () => {
    it("should delete a userDetail", async () => {
      ...
      await app.service("customerEmail").Model.findByIdAndDelete(customerEmailCreated._id);;
