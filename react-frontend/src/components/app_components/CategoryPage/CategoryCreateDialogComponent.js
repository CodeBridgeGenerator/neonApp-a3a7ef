...
const CategoryCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        if(!validate()) return;
        let _data = {
            brandName: _entity?.brandName,gender: _entity?.gender,isSale: _entity?.isSale || false,productPrice: _entity?.productPrice,productImage: _entity?.productImage,productSearch: _entity?.productSearch,sortBy: _entity?.sortBy,filterBy: _entity?.filterBy,
    ...
    return (
        <Dialog header="Create Category" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            ...
            <span className="align-items-center">
                ...
                <InputText id="brandName" className="w-full mb-3 p-inputtext-sm" value={_entity?.brandName} onChange={(e) => setValByKey("brandName", e.target.value)}  />
            </span>
...
<div className="col-12 md:col-6 field flex">
            <span className="align-items-center">
                ...
                <Checkbox id="isSale" className="ml-3" checked={_entity?.isSale} onChange={(e) => setValByKey("isSale", e.checked)}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputText className="w-full mb-3 p-inputtext-sm" value={_entity?.productImage} onChange={(e) => setValByKey("productImage", e.target.value)}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputText id="productSearch" className="w-full mb-3 p-inputtext-sm" value={_entity?.productSearch} onChange={(e) => setValByKey("productSearch", e.target.value)}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputText id="sortBy" className="w-full mb-3 p-inputtext-sm" value={_entity?.sortBy} onChange={(e) => setValByKey("sortBy", e.target.value)}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Dropdown id="filterBy" value={_entity?.filterBy} options={filterByOptions} optionLabel="name" optionValue="value" onChange={(e) => setValByKey("filterBy", e.value)}  />
            </span>
            <small className="p-error">
