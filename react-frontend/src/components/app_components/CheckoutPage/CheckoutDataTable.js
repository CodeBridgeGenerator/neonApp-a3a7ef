...
const dropdownTemplate1 = (rowData, { rowIndex }) => <p >{rowData.productTitle: {i.productTitle},description: {i.description},price: {i.price},productImage: {i.productImage}}</p>
const p_numberTemplate2 = (rowData, { rowIndex }) => <p >{rowData.subtotal}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="fullName" header="FullName" body={pTemplate0} filter={selectedFilterFields.includes("fullName")} hidden={selectedHideFields?.includes("fullName")}  sortable style={{ minWidth: "8rem" }} />
<Column field="productName" header="Product Name" body={dropdownTemplate1} filter={selectedFilterFields.includes("productName")} hidden={selectedHideFields?.includes("productName")}  style={{ minWidth: "8rem" }} />
