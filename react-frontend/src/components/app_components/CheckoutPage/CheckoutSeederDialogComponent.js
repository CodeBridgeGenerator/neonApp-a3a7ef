...
import seederData from "./checkout.seeder.json";
...
const CheckoutSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CheckoutSeederDialogComponent);
