...
const CustomerDetailsCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        if(!validate()) return;
        let _data = {
            customerName: _entity?.customerName,customerEmail: _entity?.customerEmail,customerAddress: _entity?.customerAddress,phoneNumber: _entity?.phoneNumber,gender: _entity?.gender,dateOfBirth: _entity?.dateOfBirth,
