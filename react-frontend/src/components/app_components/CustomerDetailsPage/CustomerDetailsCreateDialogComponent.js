...
const CustomerDetailsCreateDialogComponent = (props) => {
  ...
  const onSave = async () => {
    ...
    try {
      ...
      props.alert({
        type: "success",
        title: "Create info",
        message: "Info Customer Details created successfully",
      });
      ...
      props.alert({
        type: "error",
        title: "Create",
        message: "Failed to create in Customer Details",
      });
    }
    setLoading(false);
  };
  ...
  return (
    <Dialog
      header="Create Customer Details"
      visible={props.show}
      closable={false}
      onHide={props.onHide}
      modal
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="customerDetails-create-dialog-component"
      >
