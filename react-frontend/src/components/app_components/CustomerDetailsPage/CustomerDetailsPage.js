...
const CustomerDetailsPage = (props) => {
    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          ...
          type: "error",
          message: error.message || "Failed get Customer Details",
        });
      });
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("customerDetails").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
  ...
  return (
    <div className="mt-5">
        ...
        <div className="col-6 flex justify-content-end">
          <>
            ...
            <Button
              ...
              role="customerDetails-add-button"
            />
          </>
        </div>
      </div>
      ...
      />
      <CustomerDetailsCreateDialogComponent
        entity={newRecord}
        onCreateResult={onCreateResult}
      ...
      />
      <CustomerDetailsSeederDialogComponent
