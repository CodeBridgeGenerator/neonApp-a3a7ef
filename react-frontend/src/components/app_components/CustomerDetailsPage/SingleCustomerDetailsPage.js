...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Customer Email</label><p className="m-0 ml-3" >{_entity?.customerEmail}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Customer Address</label><p className="m-0 ml-3" >{_entity?.customerAddress}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Phone Number</label><p className="m-0 ml-3" >{_entity?.phoneNumber}</p></div>
