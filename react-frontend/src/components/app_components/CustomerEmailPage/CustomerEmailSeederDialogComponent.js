...
import seederData from "./customerEmail.seeder.json";
...
const CustomerEmailSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CustomerEmailSeederDialogComponent);
