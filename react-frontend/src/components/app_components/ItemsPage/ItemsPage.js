  ...
  useEffect(() => {
    ...
    client
      ...
      .find({
        query: {
          $limit: 10000,
          order: urlParams.singleOrderId,
          product: urlParams.singleProductId,
          $populate: [
            {
              path: "createdBy",
              service: "users",
