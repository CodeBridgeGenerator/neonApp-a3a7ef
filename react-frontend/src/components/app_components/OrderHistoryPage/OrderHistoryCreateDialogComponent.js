...
const OrderHistoryCreateDialogComponent = (props) => {
  ...
  useEffect(() => {
    let init = { canReorder: false, favourite: false };
  ...
  const onSave = async () => {
    ...
    let _data = {
      ...
      canReorder: _entity?.canReorder || false,
      variantLabel: _entity?.variantLabel,
      favourite: _entity?.favourite || false,
    ...
    try {
      ...
      props.alert({
        type: "success",
        title: "Create info",
        message: "Info Order History created successfully",
      });
      ...
      props.alert({
        type: "error",
        title: "Create",
        message: "Failed to create in Order History",
      });
    }
    setLoading(false);
  };
  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="orderHistory-create-dialog-component"
      >
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              ...
              value={_entity?.orderNumber}
              onChange={(e) => setValByKey("orderNumber", e.target.value)}
            />
          </span>
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <Calendar
              id="orderDate"
              value={_entity?.orderDate ? new Date(_entity?.orderDate) : null}
              dateFormat="dd/mm/yy"
              onChange={(e) => setValByKey("orderDate", new Date(e.value))}
              showIcon
              showButtonBar
            />
          </span>
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              ...
              onValueChange={(e) => setValByKey("totalAmount", e.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="orderStatus"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.orderStatus}
              onChange={(e) => setValByKey("orderStatus", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field flex">
          <span className="align-items-center">
            ...
            <Checkbox
              id="canReorder"
              className="ml-3"
              checked={_entity?.canReorder}
              onChange={(e) => setValByKey("canReorder", e.checked)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="variantLabel"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.variantLabel}
              onChange={(e) => setValByKey("variantLabel", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field flex">
          <span className="align-items-center">
            ...
            <Checkbox
              id="favourite"
              className="ml-3"
              checked={_entity?.favourite}
              onChange={(e) => setValByKey("favourite", e.checked)}
            />
          </span>
          <small className="p-error">
...
export default connect(
  mapState,
  mapDispatch,
)(OrderHistoryCreateDialogComponent);
