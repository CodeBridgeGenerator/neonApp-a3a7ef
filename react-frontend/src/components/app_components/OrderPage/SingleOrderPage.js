...
const SingleOrderPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("order")
            .get(urlParams.singleOrderId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
  ...
  const copyPageLink = () => {
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Total</label><p className="m-0 ml-3" >{_entity?.total}</p></div>
    ...
    <div className="col-12 mt-2">
      ...
      <CommentsSection
        recordId={urlParams.singleOrderId}
        user={props.user}
        alert={props.alert}
        serviceName="order"
      />
