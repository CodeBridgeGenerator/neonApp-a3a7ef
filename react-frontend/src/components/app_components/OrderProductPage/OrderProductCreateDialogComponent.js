  ...
  const onSave = async () => {
    ...
    try {
      ...
      props.alert({
        type: "success",
        title: "Create info",
        message: "Info Order Product created successfully",
      });
      ...
      props.alert({
        type: "error",
        title: "Create",
        message: "Failed to create in Order Product",
      });
    }
    setLoading(false);
  };
  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="orderProduct-create-dialog-component"
      >
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="selectedColor"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.selectedColor}
              onChange={(e) => setValByKey("selectedColor", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="selectedSize"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.selectedSize}
              onChange={(e) => setValByKey("selectedSize", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              ...
              onValueChange={(e) => setValByKey("unitPrice", e.value)}
            />
          </span>
          <small className="p-error">
