...
const OrderProductCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        if(!validate()) return;
        let _data = {
            productName: _entity?.productName,quantity: _entity?.quantity,selectedColor: _entity?.selectedColor,selectedSize: _entity?.selectedSize,unitPrice: _entity?.unitPrice,
        ...
        props.onHide();
        props.alert({ type: "success", title: "Create info", message: "Info Order Product created successfully" });
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputText id="selectedColor" className="w-full mb-3 p-inputtext-sm" value={_entity?.selectedColor} onChange={(e) => setValByKey("selectedColor", e.target.value)}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputText id="selectedSize" className="w-full mb-3 p-inputtext-sm" value={_entity?.selectedSize} onChange={(e) => setValByKey("selectedSize", e.target.value)}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="unitPrice" className="w-full mb-3" mode="currency" currency="MYR" locale="en-US" value={_entity?.unitPrice} onValueChange={(e) => setValByKey("unitPrice", e.value)}  />
            </span>
            <small className="p-error">
