...
selectedColor: _entity?.selectedColor,
selectedSize: _entity?.selectedSize,
unitPrice: _entity?.unitPrice,
        ...
        const result = await client.service("orderProduct").patch(_entity._id, _data);
        props.onHide();
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="unitPrice" className="w-full mb-3" mode="currency" currency="MYR" locale="en-US" value={_entity?.unitPrice} onValueChange={(e) => setValByKey("unitPrice", e.value)} useGrouping={false}  />
            </span>
            <small className="p-error">
