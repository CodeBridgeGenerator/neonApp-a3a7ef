...
const OrderProductPage = (props) => {
    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Order Product",
          type: "error",
          message: error.message || "Failed get Order Product",
        });
      });
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("orderProduct").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
