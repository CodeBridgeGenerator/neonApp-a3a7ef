...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Selected Color</label><p className="m-0 ml-3" >{_entity?.selectedColor}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Selected Size</label><p className="m-0 ml-3" >{_entity?.selectedSize}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Unit Price</label><p className="m-0 ml-3" ><InputNumber id="unitPrice" value={Number(_entity?.unitPrice)} mode="currency" currency="MYR" locale="en-US"   disabled={true} /></p></div>
