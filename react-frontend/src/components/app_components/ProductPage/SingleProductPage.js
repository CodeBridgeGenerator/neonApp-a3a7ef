  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            ...
            ? res.price.map((elem) => ({ _id: elem._id, productName: elem.productName }))
            : res.price
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Small Image</label><p><img id="smallImage" src={_entity?.smallImage} className="m-0 ml-3" width={300}  /></p></div>
