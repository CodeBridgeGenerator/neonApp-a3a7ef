  ...
  const onSave = async () => {
    ...
    try {
      ...
      props.alert({
        type: "success",
        title: "Create info",
        message: "Info Product Price created successfully",
      });
      ...
      props.alert({
        type: "error",
        title: "Create",
        message: "Failed to create in Product Price",
      });
    }
    setLoading(false);
  };
  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="productPrice-create-dialog-component"
      >
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              ...
              currency="MYR"
              locale="en-US"
              value={_entity?.basePrice}
              onValueChange={(e) => setValByKey("basePrice", e.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              ...
              onValueChange={(e) => setValByKey("currency", e.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="discountedPrice"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.discountedPrice}
              onChange={(e) => setValByKey("discountedPrice", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="taxPercentage"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.taxPercentage}
              onChange={(e) => setValByKey("taxPercentage", e.target.value)}
            />
          </span>
          <small className="p-error">
