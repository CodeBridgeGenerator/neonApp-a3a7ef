...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Base Price</label><p className="m-0 ml-3" ><InputNumber id="basePrice" value={Number(_entity?.basePrice)} mode="currency" currency="MYR" locale="en-US"   disabled={true} /></p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Currency</label><p className="m-0 ml-3" ><InputNumber id="currency" value={Number(_entity?.currency)} mode="currency" currency="MYR" locale="en-US"   disabled={true} /></p></div>
