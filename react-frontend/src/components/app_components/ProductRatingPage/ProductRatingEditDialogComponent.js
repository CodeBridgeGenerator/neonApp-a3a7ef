...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="totalReviewCount" className="w-full mb-3" value={_entity?.totalReviewCount} onValueChange={(e) => setValByKey("totalReviewCount", e.value)} prefix="%" mode="decimal" minFractionDigits={2} useGrouping={false}  />
            </span>
            <small className="p-error">
