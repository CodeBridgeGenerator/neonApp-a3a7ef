...
import seederData from "./productSize.seeder.json";
...
const ProductSizeSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ProductSizeSeederDialogComponent);
