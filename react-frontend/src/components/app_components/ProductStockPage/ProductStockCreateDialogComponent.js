...
const ProductStockCreateDialogComponent = (props) => {
  ...
  const onSave = async () => {
    ...
    try {
      ...
      const eagerResult = await client.service("productStock").find({
        query: {
          $limit: 10000,
          _id: { $in: [result._id] },
          $populate: [
      ...
      props.alert({
        type: "success",
        title: "Create info",
        message: "Info Product Stock updated successfully",
      });
      ...
      props.alert({
        type: "error",
        title: "Create",
        message: "Failed to create in Product Stock",
      });
    }
    setLoading(false);
  };
  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="productStock-create-dialog-component"
      >
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              ...
              onChange={(e) => setValByKey("colour", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              ...
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.quantityAvailable}
              onChange={(e) => setValByKey("quantityAvailable", e.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <Calendar
              ...
              value={
                _entity?.lastRestockedDate
                  ? new Date(_entity?.lastRestockedDate)
                  : null
              }
              dateFormat="dd/mm/yy"
              onChange={(e) =>
                setValByKey("lastRestockedDate", new Date(e.value))
              }
              showIcon
              showButtonBar
            />
