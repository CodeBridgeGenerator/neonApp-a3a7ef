...
import seederData from "./productStock.seeder.json";
...
const ProductStockSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ProductStockSeederDialogComponent);
