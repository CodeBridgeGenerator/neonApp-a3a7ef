...
const Home = (props) => {
  ...
  const getRoutePrefix = (service) =>
    CB_ADMIN_SERVICES.has(service) ? "/cbAdmin" : "/app";
  ...
  const handleAddSubSubmenu = (menuIndex, submenuIndex) => {
    setFormData((prev) => {
      const updatedMenuItems = [...prev.menuItems];
      const currentSubSubmenus =
        updatedMenuItems[menuIndex].submenus[submenuIndex].subSubmenus || [];
  ...
  const handleDeleteSubSubmenu = (menuIndex, submenuIndex, subSubmenuIndex) => {
    setFormData((prev) => {
      const updatedMenuItems = [...prev.menuItems];
      updatedMenuItems[menuIndex].submenus[submenuIndex].subSubmenus =
        updatedMenuItems[menuIndex].submenus[submenuIndex].subSubmenus.filter(
          (_, i) => i !== subSubmenuIndex,
        );
      return { ...prev, menuItems: updatedMenuItems };
    });
  };
                    ...
                    >
                      ...
                      {!collapsedMenus[menuIndex] && (
                        <>
                          ...
                          <div className="ml-4">
                            ...
                            {menu.submenus &&
                              menu.submenus.map((submenu, submenuIndex) => (
                                <div
                                  key={submenuIndex}
                                  className="mb-3 p-2 border-left-2 surface-border"
                                >
                                  {/* Submenu Header */}
                                  <div className="flex align-items-center justify-content-between mb-2">
                                    <div className="flex align-items-center">
                                        ...
                                        submenu.subSubmenus.length > 0 ? (
                                          submenu.subSubmenus.map(
                                            (subSubmenu, subSubmenuIndex) => (
                                              <div
                                                key={subSubmenuIndex}
                                                className="mb-2 p-3 border-round surface-100"
                                              >
                                                <div className="flex align-items-center justify-content-between mb-2">
                                                  <div className="flex align-items-center">
                                                  ...
                                                  <Button
                                                    ...
                                                    className="p-button-danger p-button-sm p-button-text"
                                                    onClick={() =>
                                                      handleDeleteSubSubmenu(
                                                        menuIndex,
                                                        submenuIndex,
                                                        subSubmenuIndex,
                                                      )
                                                    }
                                                    tooltip="Delete Sub-Submenu"
                                                  />
                                                </div>
                                                ...
                                                <div className="p-fluid grid">
                                                  <div className="field col-12 md:col-4">
                                                    ...
                                                    <InputText
                                                      ...
                                                      placeholder="Enter sub-submenu name"
                                                    />
                                                  </div>
                                                  <div className="field col-12 md:col-4">
                                                    <label>Route Page</label>
                          ...
                          {menuIndex === formData.menuItems.length - 1 && (
                            <Button
                              label="Add Another Main Menu"
                              icon="pi pi-plus"
                  ...
                  <ul className="m-0 p-0 list-none">
                    {formData.menuItems.map((menu, menuIndex) => (
                      <li key={menuIndex} className="mb-4">
                        <div className="flex align-items-center">
                          {menu.icon &&
                            iconOptions.find((icon) => icon.value === menu.icon)
                              ?.icon}
